...
Windows 개인 PC에 직접 설치해서 작성하려면 [2-VSCODE_LOCAL_THESIS_SETUP.md](2-VSCODE_LOCAL_THESIS_SETUP.md)를 확인합니다.
...
- [2-VSCODE_LOCAL_THESIS_SETUP.md](2-VSCODE_LOCAL_THESIS_SETUP.md)를 참고해 개인 PC에서 로컬로 컴파일한다.
