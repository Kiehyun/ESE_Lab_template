...
% Korean postposition helpers used after Table/Figure references.
\providecommand{\는}{는\space}
\providecommand{\은}{은\space}
\providecommand{\의}{의\space}
\providecommand{\와}{와\space}
\providecommand{\에}{에\space}
\providecommand{\에서}{에서\space}
