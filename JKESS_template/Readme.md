...
설치 방법은 [2-VSCODE_LOCAL_THESIS_SETUP.md](../2-VSCODE_LOCAL_THESIS_SETUP.md)를 참고합니다. Windows에서는 `.\JKESS_main_build.cmd`를, macOS/Linux에서는 `./JKESS_main_build.sh`를 사용합니다.
