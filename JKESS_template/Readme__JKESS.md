...
설치 방법은 [3-VSCODE_TeXLive_SETUP.md](../manual/3-VSCODE_TeXLive_SETUP.md)를 참고합니다. Windows에서는 `.\JKESS_main_build.cmd`를, macOS/Linux에서는 `./JKESS_main_build.sh`를 사용합니다.
