...
> **권장 사용 방식 — Obsidian 볼트로 열기.** 이 저장소는 그 자체로 하나의 **Obsidian 볼트**입니다(볼트 설정 `.obsidian/`이 함께 들어 있어 내려받으면 바로 볼트가 됩니다). 내려받은 뒤 **Obsidian에서 폴더째 "Open folder as vault"로 여는 것을 기본 사용 방식으로 권장합니다.** 그러면 템플릿·안내문·문헌 노트·연구 일지·AI 작업 일지가 한 화면에서 연결됩니다. LaTeX 편집과 빌드는 그대로 VS Code나 Overleaf에서 하면 되고, 두 도구를 함께 열어 두어도 충돌하지 않습니다. 자세한 방법은 [5-OBSIDIAN_VAULT_SETUP.md](manual/5-OBSIDIAN_VAULT_SETUP.md)를 참고하세요.
...
| 목적 | 먼저 볼 문서 |
| --- | --- |
| LaTeX 자체가 무엇이고 어떻게 동작하는지 알아보기 | [1-LATEX_BASICS.md](manual/1-LATEX_BASICS.md) |
| Overleaf에서 학위논문 프로젝트 만들기 | [2-OVERLEAF_THESIS_PROJECT.md](manual/2-OVERLEAF_THESIS_PROJECT.md) |
| Windows 개인 PC에 LaTeX을 설치해서 학위논문 작성하기 | [3-VSCODE_TeXLive_SETUP.md](manual/3-VSCODE_TeXLive_SETUP.md) |
| Python, conda, VS Code로 데이터 분석 환경 만들기 | [4-PYTHON_CONDA_VSCODE_SETUP.md](manual/4-PYTHON_CONDA_VSCODE_SETUP.md) |
| 이 저장소를 Obsidian 볼트로 열어 문헌 노트·연구 일지 관리하기 | [5-OBSIDIAN_VAULT_SETUP.md](manual/5-OBSIDIAN_VAULT_SETUP.md) |
| VS Code PowerShell에서 Claude Code(AI 코딩 에이전트) 설치·사용하기 | [6-CLAUDE_CODE_SETUP.md](manual/6-CLAUDE_CODE_SETUP.md) |
| 이 볼트를 사람+AI가 함께 쓰는 위키(llmwiki)로 활용하기 | [7-LLMWIKI_GUIDE.md](manual/7-LLMWIKI_GUIDE.md) |
| KNUE_thesis 템플릿 파일 구조·빌드·석사박사 전환 등 양식 사용법 | [8-KNUE_THESIS_TEMPLATE_USAGE.md](manual/8-KNUE_THESIS_TEMPLATE_USAGE.md) |
| 한국교원대학교 학위논문 템플릿 파일별 작성법 보기 | [KNUE_thesis/Readme__KNUEthesis.md](KNUE_thesis/Readme__KNUEthesis.md) |

LaTeX을 처음 접한다면 **1번 문서**로 개념부터 가볍게 훑어보는 것을 권장합니다. 처음 학위논문을 작성한다면 **2번 Overleaf 방식**으로 먼저 PDF를 만들어 보는 것을 권장합니다. 개인 PC에 LaTeX을 직접 설치해 장기적으로 관리하려면 3번 문서를 따라가면 됩니다. 논문 자료 분석이나 그래프 작성에 Python을 사용할 때는 4번 문서를 참고합니다.
...
- **AI를 쓰려면 Python 환경부터 준비합니다.** Claude Code·GPT Codex·GitHub Copilot 같은 AI 도구의 도움을 원활히 받으려면, 먼저 **Python을 설치하고 가상환경(conda 등)을 구성**해 두는 것이 좋습니다 → [4-PYTHON_CONDA_VSCODE_SETUP.md](manual/4-PYTHON_CONDA_VSCODE_SETUP.md).
- **Claude Code 설치·사용법**은 Windows VS Code PowerShell 기준으로 정리해 두었습니다 → [6-CLAUDE_CODE_SETUP.md](manual/6-CLAUDE_CODE_SETUP.md).
...
볼트 활용법(문헌 노트·연구 일지·AI 작업 일지)의 자세한 안내는 [5-OBSIDIAN_VAULT_SETUP.md](manual/5-OBSIDIAN_VAULT_SETUP.md)를 참고하세요.
...
- Overleaf 사용: [2-OVERLEAF_THESIS_PROJECT.md](manual/2-OVERLEAF_THESIS_PROJECT.md)
- Windows 로컬 설치 사용: [3-VSCODE_TeXLive_SETUP.md](manual/3-VSCODE_TeXLive_SETUP.md)

템플릿 내부 파일을 수정할 때:

- 장별로 무엇을 써야 하는지(과학교육 논문 작성법): [KNUE_thesis/Readme__KNUEthesis.md](KNUE_thesis/Readme__KNUEthesis.md)
- 파일 구조, 빌드 방법, 석사/박사 전환, 인용·표·그림 LaTeX 명령(양식 사용법): [manual/8-KNUE_THESIS_TEMPLATE_USAGE.md](manual/8-KNUE_THESIS_TEMPLATE_USAGE.md)
...
논문 작성 중 자료 분석, 그래프 작성, ENA 스타일 네트워크 예제 실행, AI 확장으로 Python 코드 요청하기는 [4-PYTHON_CONDA_VSCODE_SETUP.md](manual/4-PYTHON_CONDA_VSCODE_SETUP.md)를 확인합니다.
...
│   ├─ 1-LATEX_BASICS.md
│   ├─ 2-OVERLEAF_THESIS_PROJECT.md
│   ├─ 3-VSCODE_TeXLive_SETUP.md
│   ├─ 4-PYTHON_CONDA_VSCODE_SETUP.md
│   ├─ 5-OBSIDIAN_VAULT_SETUP.md
│   ├─ 6-CLAUDE_CODE_SETUP.md
│   ├─ 7-LLMWIKI_GUIDE.md
│   └─ 8-KNUE_THESIS_TEMPLATE_USAGE.md
...
> 연구 일지를 관리하는 방법은 [5-OBSIDIAN_VAULT_SETUP.md](manual/5-OBSIDIAN_VAULT_SETUP.md)를
> 참고하세요.
