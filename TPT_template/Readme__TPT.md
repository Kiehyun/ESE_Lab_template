...
See [2-VSCODE_LOCAL_THESIS_SETUP.md](../manual/2-VSCODE_LOCAL_THESIS_SETUP.md) for installation. Use `.\TPT_main_build.cmd` on Windows or `./TPT_main_build.sh` on macOS/Linux.
